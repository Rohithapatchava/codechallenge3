<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="codechallenge3.Student" %>
...
<asp:Content ID="cont1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotran">
        ...
        <asp:Label ID="Label3" runat="server" Text="Studentcourse"></asp:Label>
